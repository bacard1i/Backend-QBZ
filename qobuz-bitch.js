...
var preloadTrack = function(trackId) {
  ...
  // Keep only last 20 tracks in queue
...
return {
  ...
  author: "bacardii",
  version: "1.4",
  description: "Direct Qobuz Hi-Res with Instant Playback + Auto Preload (5 tracks)",
  labels: ["QOBUZ", "HI-RES", "PRELOAD", "INSTANT", "STABLE"],
